export interface Unit {
    ...
    size: number;
    color: string;
    status: "Available" | "Sold" | "Reserved" | "SOLD - 72hr clause";
    price: string;
    images?: string[];
}
...
export const units: Unit[] = [
    // First Floor
    {
        unitNo: "CS101", floor: "First", bedrooms: 1, bathrooms: 1, size: 47, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R1,700,000",
    ...
    {
        unitNo: "CS102", floor: "First", bedrooms: 2, bathrooms: 1, size: 67, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R2,300,000",
    ...
    {
        unitNo: "CS103", floor: "First", bedrooms: 1, bathrooms: 1, size: 45, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R1,700,000",
    ...
    {
        unitNo: "CS104", floor: "First", bedrooms: 1, bathrooms: 1, size: 48, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R1,700,000",
    ...
    {
        unitNo: "CS106", floor: "First", bedrooms: 1, bathrooms: 1, size: 45, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R1,700,000",
    ...
    {
        unitNo: "CS108", floor: "First", bedrooms: 1, bathrooms: 1, size: 47, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R1,700,000",
    ...
    {
        unitNo: "CS302", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R2,725,000",
    ...
    {
        unitNo: "CS303", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R2,725,000",
    ...
    {
        unitNo: "CS304", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "SOLD - 72hr clause", price: "R2,725,000",
