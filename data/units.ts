export interface Unit {
    ...
    color: string;
    status: "Available" | "Sold" | "Reserved" | "Under Offer";
    price: string;
    images?: string[];
}
...
export const units: Unit[] = [
    // First Floor
    { unitNo: "CS101", floor: "First", bedrooms: 1, bathrooms: 1, size: 47, color: "#3b82f6", status: "Under Offer", price: "R1,700,000" },
    { unitNo: "CS102", floor: "First", bedrooms: 2, bathrooms: 1, size: 67, color: "#8b5cf6", status: "Under Offer", price: "R2,300,000" },
    { unitNo: "CS103", floor: "First", bedrooms: 1, bathrooms: 1, size: 45, color: "#3b82f6", status: "Under Offer", price: "R1,700,000" },
    { unitNo: "CS104", floor: "First", bedrooms: 1, bathrooms: 1, size: 48, color: "#3b82f6", status: "Under Offer", price: "R1,700,000" },
    { unitNo: "CS105", floor: "First", bedrooms: 1, bathrooms: 1, size: 48, color: "#3b82f6", status: "Sold", price: "R1,700,000" },
    { unitNo: "CS106", floor: "First", bedrooms: 1, bathrooms: 1, size: 45, color: "#3b82f6", status: "Under Offer", price: "R1,700,000" },
    { unitNo: "CS107", floor: "First", bedrooms: 2, bathrooms: 1, size: 67, color: "#8b5cf6", status: "Sold", price: "R2,300,000" },
    { unitNo: "CS108", floor: "First", bedrooms: 1, bathrooms: 1, size: 47, color: "#3b82f6", status: "Under Offer", price: "R1,700,000" },
    ...
    { unitNo: "CS306", floor: "Third", bedrooms: 2, bathrooms: 1, size: 67, color: "#8b5cf6", status: "Sold", price: "R2,300,000" },
];
