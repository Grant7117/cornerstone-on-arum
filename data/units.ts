...
export const units: Unit[] = [
    // First Floor
    { unitNo: "CS101", floor: "First", bedrooms: 1, bathrooms: 1, size: 47, color: "#3b82f6", status: "Pending", price: "R1,600,000" },
    { unitNo: "CS102", floor: "First", bedrooms: 2, bathrooms: 1, size: 67, color: "#8b5cf6", status: "Pending", price: "R2,100,000" },
    { unitNo: "CS103", floor: "First", bedrooms: 1, bathrooms: 1, size: 45, color: "#3b82f6", status: "Pending", price: "R1,600,000" },
    { unitNo: "CS104", floor: "First", bedrooms: 1, bathrooms: 1, size: 48, color: "#3b82f6", status: "Pending", price: "R1,600,000" },
    { unitNo: "CS105", floor: "First", bedrooms: 1, bathrooms: 1, size: 48, color: "#3b82f6", status: "Sold", price: "R1,600,000" },
    { unitNo: "CS106", floor: "First", bedrooms: 1, bathrooms: 1, size: 45, color: "#3b82f6", status: "Pending", price: "R1,500,000" },
    { unitNo: "CS107", floor: "First", bedrooms: 2, bathrooms: 1, size: 67, color: "#8b5cf6", status: "Sold", price: "R2,100,000" },
    { unitNo: "CS108", floor: "First", bedrooms: 1, bathrooms: 1, size: 47, color: "#3b82f6", status: "Pending", price: "R1,600,000" },
    ...
    {
        unitNo: "CS302", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "Pending", price: "R2,600,000"
    },
    {
        unitNo: "CS303", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "Pending", price: "R2,600,000"
    },
    {
        unitNo: "CS304", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "Pending", price: "R2,600,000",
        images: [
