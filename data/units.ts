...
export const units: Unit[] = [
    ...
    {
        unitNo: "CS302", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "Available", price: "R2,600,000"
    },
    {
        unitNo: "CS303", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "Reserved", price: "R2,600,000"
    },
    {
        unitNo: "CS304", floor: "Third+Loft", bedrooms: 2, bathrooms: 2, size: 77, color: "#f59e0b", status: "Available", price: "R2,600,000",
        images: [
