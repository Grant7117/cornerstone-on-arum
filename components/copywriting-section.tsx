...
// Sections: Financial, Structural, Security, Returns
// ─────────────────────────────────────────────────────────────────────────────
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 border-t border-muted-bronze/10">
                  <p className="font-sans text-xs uppercase tracking-widest text-muted-bronze font-bold mb-2">BetterBond Consultant</p>
                  <p className="font-serif text-xl text-deep-obsidian">Yolanda Kensley</p>
                  <div className="flex flex-col space-y-1 mt-2">
                    <a href="tel:0846457216" className="font-sans text-sm text-deep-obsidian/70 hover:text-muted-bronze transition-colors">084 645 7216</a>
                    <a href="mailto:yolanda.kensley@betterbond.co.za" className="font-sans text-sm text-deep-obsidian/70 hover:text-muted-bronze transition-colors">yolanda.kensley@betterbond.co.za</a>
                  </div>
                </div>
              </div>
            </div>
